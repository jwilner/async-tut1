...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16617 = 0;while(true){
var m_16618 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16618 == null))
{} else
{m_16618.call(null);
if((count_16617 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16619 = (count_16617 + 1);
count_16617 = G__16619;
continue;
}
} else
{}
