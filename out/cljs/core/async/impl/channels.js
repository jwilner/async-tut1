...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16623 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16623 = (function (val,box,meta16624){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16623.cljs$lang$type = true;
cljs.core.async.impl.channels.t16623.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16623";
cljs.core.async.impl.channels.t16623.cljs$lang$ctorPrWriter = (function (this__3670__auto__,writer__3671__auto__,opt__3672__auto__){return cljs.core._write.call(null,writer__3671__auto__,"cljs.core.async.impl.channels/t16623");
});
cljs.core.async.impl.channels.t16623.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16623.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16625){var self__ = this;
var _16625__$1 = this;return self__.meta16624;
});
cljs.core.async.impl.channels.t16623.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16625,meta16624__$1){var self__ = this;
var _16625__$1 = this;return (new cljs.core.async.impl.channels.t16623(self__.val,self__.box,meta16624__$1));
});
cljs.core.async.impl.channels.__GT_t16623 = (function __GT_t16623(val__$1,box__$1,meta16624){return (new cljs.core.async.impl.channels.t16623(val__$1,box__$1,meta16624));
});
}
return (new cljs.core.async.impl.channels.t16623(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_16626 = self__.takes.pop();if((taker_16626 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16626))
{var take_cb_16627 = cljs.core.async.impl.protocols.commit.call(null,taker_16626);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16627,taker_16626){
return (function (){return take_cb_16627.call(null,null);
});})(take_cb_16627,taker_16626))
);
} else
{}
{
