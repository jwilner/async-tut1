...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_16594 = 0;while(true){
if((i_16594 < arr.length))
{(arr[i_16594] = null);
{
...
{var i_16601 = (self__.level + 1);while(true){
if((i_16601 <= (new_level + 1)))
{(update[i_16601] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_16603 = 0;while(true){
if((i_16603 <= self__.level))
{var links_16604 = (update[i_16603]).forward;if(((links_16604[i_16603]) === x__$1))
{(links_16604[i_16603] = (x__$1.forward[i_16603]));
{
var G__16605 = (i_16603 + 1);
i_16603 = G__16605;
continue;
}
} else
{{
var G__16606 = (i_16603 + 1);
i_16603 = G__16606;
continue;
}
}
